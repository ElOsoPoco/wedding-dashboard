...
function getDashboard(){    
    ...
    $.ajax({
      ...
      url: 'http://zackandtiffany2018.com/WeddingDashboard/webresources/dashboard/post_dashboard',
      //url: 'http://localhost:8080/WeddingDashboard/webresources/dashboard/post_dashboard',      
      ...
      error: function() {
        $("#dashboard").html("<b>An error has occurred!</b><br \> \n\
